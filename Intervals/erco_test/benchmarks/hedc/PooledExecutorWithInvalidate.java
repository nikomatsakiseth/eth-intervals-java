 ...
 * --> (Doug Lea)                                      <--
 * 
 * @version $Id: PooledExecutorWithInvalidate.java 3342 2003-07-31 09:36:46Z praun $
...
public class PooledExecutorWithInvalidate {
     ...
     * @exception IllegalArgumentException if less than zero. (It is
	...
	Worker(Task firstTask) { firstTask_ = firstTask; }
