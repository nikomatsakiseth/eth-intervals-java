...
public class SohoSynoptic extends MetaSearchResult {
	...
	TYPE_CODES_.put("halph", "H alpha 6563 Å");
	TYPE_CODES_.put("lalph", "Lyman-alpha 1216 Å");
	TYPE_CODES_.put("heimp", "He I 10830, synoptic map");
	TYPE_CODES_.put("magfe", "Magnetogram, Fe 5250 Å");
	TYPE_CODES_.put("magna", "Magnetogram, Na 5896 Å");
	...
	TYPE_CODES_.put("00171", "Fe IX/X line 171 Å");
	TYPE_CODES_.put("00195", "Fe XII line 195 Å");
	TYPE_CODES_.put("00284", "Fe XV line 284 Å");
	TYPE_CODES_.put("00302", "He II line 304 Å");
	TYPE_CODES_.put("10830", "He I line 10830 Å");
	TYPE_CODES_.put("01216", "1216 Å");
	TYPE_CODES_.put("01550", "1550 Å");
	TYPE_CODES_.put("01600", "1600 Å");
	TYPE_CODES_.put("01700", "1700 Å");
	TYPE_CODES_.put("000WL", "White light");
	TYPE_CODES_.put("00171", "Fe IX/X line, 171 Å");
	TYPE_CODES_.put("00195", "Fe XII line, 195 Å");
	TYPE_CODES_.put("00284", "Fe XV line, 284 Å");
	TYPE_CODES_.put("00304", "He II line, 304 Å");
	//------------------------------------------------------------------
	//              CDS images
	//------------------------------------------------------------------
	TYPE_CODES_.put("00361", "Fe XVI line, 361 Å");
	TYPE_CODES_.put("00368", "Mg IX line, 368 Å");
	TYPE_CODES_.put("00584", "He I line, 584 Å");
	TYPE_CODES_.put("00630", "O V line, 630 Å");
	//------------------------------------------------------------------
	//              LASCO images
	//------------------------------------------------------------------
	...
	//              UVCS images
	//------------------------------------------------------------------
	TYPE_CODES_.put("01032", "O VI 1032 Å");
	TYPE_CODES_.put("01206", "Si III, 1206 Å");
	TYPE_CODES_.put("lalph", "Lyman Alpha 1216 Å");
	TYPE_CODES_.put("lbeta", "Lyman Beta 1025 Å");
	TYPE_CODES_.put("01238", "N V, 1238  Å");
	TYPE_CODES_.put("01242", "Fe XII, 1242 Å");
	//------------------------------------------------------------------
	//              SUMER images
	//------------------------------------------------------------------
	TYPE_CODES_.put("00770", "Ne VIII, 770 Å");
	TYPE_CODES_.put("00933", "S VI line, 933 Å");
	TYPE_CODES_.put("00937", "Lyman Epsilon, 937 Å");
	TYPE_CODES_.put("00944", "S VI line, 944 Å");
	TYPE_CODES_.put("00977", "C III line, 977 Å");
	TYPE_CODES_.put("01548", "C IV line, 1584 Å");
	//------------------------------------------------------------------
	//		UVCS-EIT composites
	//------------------------------------------------------------------
	TYPE_CODES_.put("lc171", "LyA 1216 Å / Fe IX/X 171 Å");
	TYPE_CODES_.put("lc195", "LyA 1216 Å / Fe XII 195 Å");
	TYPE_CODES_.put("lc284", "LyA 1216 Å / Fe XV 284 Å");
	TYPE_CODES_.put("lc304", "LyA 1216 Å / He II 304 Å");
	TYPE_CODES_.put("oc171", "O VI 1032 Å / Fe IX/X 171 Å");
	TYPE_CODES_.put("oc195", "O VI 1032 Å / Fe XII 195 Å");
	TYPE_CODES_.put("oc284", "O VI 1032 Å / Fe XV 284 Å");
	TYPE_CODES_.put("oc304", "O VI 1032 Å / He II 304 Å");
