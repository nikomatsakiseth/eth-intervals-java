 ...
 * All rights reserved
 *
 * $Id: Rag.java 96 2001-03-16 18:00:29Z praun $
 * 
 * 03/02/99  cvp
 *
 */
...
public class Rag extends MetaSearchResult {
	...
	public Object next() {
		...
		try {
		    ...
		    Messages.debug(-1, "Rag::exception during parsing of s=%1 (%2)", tmp.substring(59, 73), e);
		    // e.printStackTrace();
		}
	    }
	    return h_;
	...
	dateFormatter2_.applyPattern("yyyyMMdd"); //"yyyyMMddHH"
	dateFormatter3_.applyPattern("yyyyMMddHHmmss");
	                           // 20000322120000
	System.out.println("Still here Rag");
    }
