 ...
 * All rights reserved
 *
 * $Id: SohoSynoptic.java 96 2001-03-16 18:00:29Z praun $
 * 
 * 03/02/99  cvp
 *
 */
...
public class SohoSynoptic extends MetaSearchResult {
    ...
    static { 
	System.out.println("Still here SohoSynoptic");
	...
	public Object next() {
		...
		try {
		    ...
		    Messages.debug(-1, "Soho::exception during parsing of (%2)", e);
		    // e.printStackTrace();
		}
	    }
	    return h_;
