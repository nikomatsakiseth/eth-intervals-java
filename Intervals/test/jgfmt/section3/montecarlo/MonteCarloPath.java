...
public class MonteCarloPath extends PathId {
	 ...
	 * @param nTimeSteps
	 *            The number of time steps for which to generate the random
	 *            path.
	...
	/**
	 * Method for writing out the values from a Monte Carlo path into a data
	 * file. This can then be fed back in as a test. The data are written in the
	 * following format:
	 * 
	 * <pre>
	 ...
	 * 
	 * @param dirName
	 *            the directory in which to write the data file.
	 * @param filename
	 ...
	 * @exception DemoException
	 *                thrown if there was a problem creating the RatePath
	 *                object.
	 */
