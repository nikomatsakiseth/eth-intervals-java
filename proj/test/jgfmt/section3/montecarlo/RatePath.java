...
public class RatePath extends PathId {
	...
	/**
	 * Constructor, for when the user specifies simply an array of values for
	 * the path. User must also include information for specifying the other
	...
	public ReturnPath getReturnCompounded() throws DemoException {
		...
		ReturnPath rPath = new ReturnPath(
				returnPathValue,
				nAcceptedPathValue,
