...
/**
 * Base class for all non-trivial classes. Used as a centralised repository for
 * all the functionalities which all classes written by me, which will be of
 * use.
 * 
 * @author H W Yau
...
public class Universal {
	...
	// ------------------------------------------------------------------------
	/**
	 * Class variable, for whether to print debug messages. This one is unique
	 * to this class, and can hence be set in the one place.
	 */
	...
	// ------------------------------------------------------------------------
	/**
	 * Variable, for whether to print debug messages. This one can be set by
	 ...
	 * 
	 * @param DEBUG
	 *            the value to set for the instance variable <code>DEBUG</code>.
	 */
	 ...
	 * 
	 * @param prompt
	 *            the value to set for the instance variable <code>prompt</code>
	 *            .
	 */
	 ...
	 * 
	 * @param s
	 *            The debug message to print out, to PrintStream "out".
	 */
	 ...
	 * 
	 * @param s
	 *            The error message to print out, to PrintStream "err".
	 */
